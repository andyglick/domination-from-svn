...
*/
			...
			DefaultTableCellRenderer colorRenderer = new DefaultTableCellRenderer() {
				public void setValue(Object value) {
					if (value instanceof NamedColor) {
						...
						setBackground(c);
						setForeground( RiskUtil.getTextColorFor( c ) );
						setText(c.toString());
					} else {
			...
			colorComboBox.addActionListener(
				...
				public void actionPerformed(ActionEvent a) {
					...
					colorComboBox.setForeground( RiskUtil.getTextColorFor(c) );
				...
				new ActionListener() {
					public void actionPerformed(ActionEvent a) {
						...
						if (localGame) {
							...
							int result = JOptionPane.showOptionDialog( 
								RiskUtil.findParentFrame(SwingGUIPanel.this),			// the parent that the dialog blocks 
								message,				// the dialog message array 
			...
			chooseMap.addActionListener(
					new ActionListener() {
						public void actionPerformed(ActionEvent a) {
							...
							String name = RiskUtil.getNewFile( RiskUtil.findParentFrame(SwingGUIPanel.this), RiskFileFilter.RISK_MAP_FILES);
			...
			chooseCards.addActionListener(
					new ActionListener() {
						public void actionPerformed(ActionEvent a) {
							...
							String name = RiskUtil.getNewFile( RiskUtil.findParentFrame(SwingGUIPanel.this), RiskFileFilter.RISK_CARDS_FILES);
		...
		public NamedColor findColor(Color color) {

				// go though array of colors and find correct NamedColor

				for (int a=0; a < namedColors.length; a++) {

					if (namedColors[a].getRGB()==color.getRGB()) { return namedColors[a]; }
